    ...
    template: `
        ...
        @if (hasRouterLink() && !hasChildren() && isVisible()) {
            <a
                ...
                [routerLinkActiveOptions]="item().routerLinkActiveOptions || { queryParams: 'ignored', matrixParams: 'ignored', fragment: 'ignored' }"
...
export class AppMenuitem {
    ...
    isTooltipDisabled = computed(() => !((this.layoutService.isCompact() || this.layoutService.isReveal()) && this.root() && !this.isActive()));
